...
export const Route = createFileRoute("/paralegal/")({
  head: () => ({ meta: [{ title: "Staff dashboard — Odhikar" }, { name: "robots", content: "noindex" }] }),
  component: Dashboard,
});
...
function Dashboard() {
  ...
  return <main className="mx-auto max-w-7xl px-5 py-8">
    <div className="flex flex-wrap items-end justify-between gap-4">
      ...
      <Button asChild><Link to="/paralegal/cases">Open case queue <ArrowRight className="size-4" /></Link></Button>
    </div>
