...
export const Route = createFileRoute("/paralegal_/login")({
  head: () => ({
    meta: [
      { title: "Staff sign in — Odhikar internal" },
      {
        name: "description",
        content: "Internal sign in for Odhikar legal-aid paralegals and clinic coordinators.",
      },
      { property: "og:title", content: "Staff sign in — Odhikar internal" },
      {
        property: "og:description",
        content: "Authorised legal-aid staff only. Case records contain sensitive statements.",
      },
