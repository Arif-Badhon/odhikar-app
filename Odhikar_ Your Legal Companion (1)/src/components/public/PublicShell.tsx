          ...
          <nav className="flex flex-col">
            {NAV.map((n) => (
              <Link
                ...
                className={`rounded-lg px-3 py-3 text-base ${lang === "bn" ? "bn" : ""}`}
    ...
    <footer className="border-t border-border bg-secondary/50">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:grid-cols-4 md:px-6">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
            <li>
              <Link to="/intake" className="bn hover:text-foreground">
                সহায়তা শুরু করুন
              </Link>
            </li>
            <li>
              <Link to="/knowledge" className="bn hover:text-foreground">
                আইন বিষয়ক তথ্যভাণ্ডার
              </Link>
            </li>
            <li>
              <Link to="/report" className="bn hover:text-foreground">
                অপরাধ রিপোর্ট
              </Link>
            </li>
            <li>
              <Link to="/about" className="bn hover:text-foreground">
                সেবা ও সীমাবদ্ধতা
              </Link>
            </li>
            <li>
              <Link to="/paralegal/login" className="hover:text-foreground">
        ...
        <div>
          ...
          <p className="bn mt-3 text-sm leading-relaxed text-muted-foreground">
            ...
            দাখিল হয় না। একজন প্যারালিগ্যাল সব কিছু দেখে অনুমোদন না দেওয়া পর্যন্ত কিছুই চূড়ান্ত নয়।
          </p>
