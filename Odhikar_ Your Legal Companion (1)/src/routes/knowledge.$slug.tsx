...
export const Route = createFileRoute("/knowledge/$slug")({
  ...
  head: ({ loaderData }) => {
    if (!loaderData)
      return {
        meta: [{ title: "Unavailable — অধিকার" }, { name: "robots", content: "noindex" }],
      };
    const a = loaderData.article;
    return {
      meta: [
        { title: `${a.titleBn} — অধিকার` },
        { name: "description", content: a.summaryBn },
        { property: "og:title", content: `${a.titleBn} — অধিকার` },
        { property: "og:description", content: a.summaryBn },
