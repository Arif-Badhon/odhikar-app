...
export const Route = createFileRoute("/paralegal/$caseId")({
  head: () => ({
    meta: [
      { title: "Case detail — Odhikar paralegal" },
      {
        name: "description",
        content:
          "Editable structured case summary, original transcript and audio, gaps, and template-based draft complaint for paralegal review.",
      },
      { property: "og:title", content: "Case detail — Odhikar paralegal" },
      {
        property: "og:description",
        content: "Review, edit and approve an automated legal aid intake record.",
      },
    ],
  }),
    ...
    return (
      <main className="mx-auto max-w-3xl px-5 py-16 text-center">
        ...
        <Button asChild className="mt-6">
          <Link to="/paralegal">Back to queue</Link>
        </Button>
      </main>
    );
