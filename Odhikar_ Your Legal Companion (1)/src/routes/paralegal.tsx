...
export const Route = createFileRoute("/paralegal")({
  ...
  component: ParalegalLayout,
});

function ParalegalLayout() {
      ...
      <header className="border-b border-border bg-primary text-primary-foreground shadow-sm">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-6 gap-y-2 px-5 py-3">
          ...
          <nav className="flex items-center gap-4 text-sm">
            <Link to="/paralegal" className="flex items-center gap-1.5 opacity-80 hover:opacity-100">
              <BarChart3 className="size-3.5" /> Dashboard
            </Link>
            <Link to="/paralegal/cases" className="flex items-center gap-1.5 opacity-80 hover:opacity-100">
              <BriefcaseBusiness className="size-3.5" /> Cases
            </Link>
            <Link to="/paralegal/training" className="flex items-center gap-1.5 opacity-80 hover:opacity-100">
