...
export const Route = createFileRoute("/knowledge/")({
  head: () => ({
    meta: [
      { title: "আইন বিষয়ক তথ্যভাণ্ডার — অধিকার | Legal knowledge" },
      {
        name: "description",
        content:
          "Plain-language Bangla legal information for Bangladesh: dower, dowry, safety, land and inheritance, wages, police complaints and legal aid.",
      },
      { property: "og:title", content: "আইন বিষয়ক তথ্যভাণ্ডার — অধিকার" },
      {
        property: "og:description",
        content: "General legal information in simple Bangla — not individual legal advice.",
      },
